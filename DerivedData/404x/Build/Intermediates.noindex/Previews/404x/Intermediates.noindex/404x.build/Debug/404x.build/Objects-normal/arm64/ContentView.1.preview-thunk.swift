...
extension ContentView {
    @_dynamicReplacement(for: body) private var __preview__body: some View {
        ...
        VStack {
            Image(systemName: __designTimeString("#8861.[1].[0].property.[0].[0].arg[0].value.[0].arg[0].value", fallback: "globe"))
                .imageScale(.large)
                .foregroundColor(.accentColor)
            Text(__designTimeString("#8861.[1].[0].property.[0].[0].arg[0].value.[1].arg[0].value", fallback: "Hello, world!"))
        }
        .padding()
